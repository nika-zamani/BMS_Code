...
uint8_t muxSet(uint8_t mux, uint8_t pin){
    ...
    uint8_t data[12] = { 0x60, 0x08, 0x00, 0x09, 0x70, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    uint8_t data_buff[12] = { 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00,};
    data[0] |= (addr>>4)&0x0f;
    data[1] |= (addr<<4)&0xf0;
    data[3] |= (comm<<4)&0xf0;
