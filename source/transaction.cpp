...
void transaction(void *pvParameters)
{
    ...
    for (;;)
    {
        ...
        time = start ? t_SLEEP + 1 : (xTaskGetTickCount() - lastMessage);
        start = 0;
                    ...
                    uint8_t arg1, uint8_t arg2, uint8_t arg3, uint8_t arg4)
{
    ...
    case ADCV: // arg1 = md, arg2 = dcp, arg3 = ch
        ...
        com.code[1] |= (arg1 & 0b1) << 7 | (arg2 & 0b1) << 4 | (arg3 & 0b111) << 0;
        break;
    case ADOW: // arg1 = md, arg2 = pup, arg3 = dcp, arg4 = ch
        com.code[0] |= (arg1 & 0b10) >> 1;
        com.code[1] |= (arg1 & 0b1) << 7 | (arg2 & 0b1) << 6 | (arg3 & 0b1) << 4 | (arg4 & 0b111) << 0;
        break;
    case CVST: // arg1 = md, arg2 = st
        com.code[0] |= (arg1 & 0b10) >> 1;
        com.code[1] |= (arg1 & 0b1) << 7 | (arg2 & 0b11) << 6;
        break;
    case ADOL: // arg1 = md, arg2 = dcp
        com.code[0] |= (arg1 & 0b10) >> 1;
        com.code[1] |= (arg1 & 0b1) << 7 | (arg2 & 0b1) << 4;
        break;
    case ADAX: // arg1 = md, arg2 = chg
        com.code[0] |= (arg1 & 0b10) >> 1;
        com.code[1] |= (arg1 & 0b1) << 7 | (arg2 & 0b111) << 0;
        break;
 ...
 *  @param pin: The pin to set the multiplexer to (0 - 3) -- (0 - 7)
 *
